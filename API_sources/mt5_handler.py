...
class MT5Handler:
    ...
    def place_order(self, request: Dict[str, Any]) -> TradeResult:
        ...
        if check_result.retcode != mt5.TRADE_RETCODE_DONE:
            ...
            raise TradeExecutionError(f"Order check failed: {check_result.comment} (retcode: {check_result.retcode})")
        ...
        if result.retcode != mt5.TRADE_RETCODE_DONE:
            ...
            raise TradeExecutionError(f"Order send failed: {result.comment} (retcode: {result.retcode})")
